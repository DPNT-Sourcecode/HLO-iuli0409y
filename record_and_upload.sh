...
# Determine which Java runtime to use based on JAVA_RUNTIME environment variable.
if [ "${JAVA_RUNTIME}" == "system" ]; then
  JAVA_BIN="java" # Use the Java runtime available on the PATH
  echo "Running using system Java runtime"
else
